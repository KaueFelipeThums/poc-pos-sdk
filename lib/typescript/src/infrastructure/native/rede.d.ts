...
export declare const RedePrinterNative: IPrinterModule;
export declare const RedeTefNative: ITefModule;
export declare const RedeScannerNative: IScannerModule;
//# sourceMappingURL=rede.d.ts.map